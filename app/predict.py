...
model = to_device(ResNet9(3, 38), torch.device("cpu")) 
...
try:
    ...
    train_classes = ['Apple___Apple_scab', 'Apple___Black_rot', 'Apple___Cedar_apple_rust', 'Apple___healthy', 'Blueberry___healthy', 
