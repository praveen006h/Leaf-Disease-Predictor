Main_Code MATLAB Python Package
...
2. Installing the Main_Code Package

A. Change to the directory that contains the file setup.py and the subdirectory 
Main_Code. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the Main_Code Package

The Main_Code package is on your Python path. To import it into a Python script or 
session, execute:
